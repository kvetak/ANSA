...
#include "networklayer/common/ModulePathAddress.h"
#include "networklayer/common/ModuleIdAddress.h"

#ifdef WITH_IPv4
#include "networklayer/configurator/ipv4/IPv4NetworkConfigurator.h"

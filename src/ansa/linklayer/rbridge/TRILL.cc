...
bool TRILL::egressNativeMulticastRemote(TRILL::tFrameDescriptor &frameDesc){
    ...
    std::vector<SystemID> *systemIDs = this->isis->getSystemIDsFromTreeOnlySource(this->isis->getNickname(), this->isis->getSystemId());
    ...
    for(std::vector<SystemID>::iterator it = systemIDs->begin(); it != systemIDs->end(); ++it){
...
bool TRILL::egressTRILLDataMultiDestRemote(TRILL::tFrameDescriptor &frameDesc){
    ...
    std::vector<SystemID> *systemIDs = this->isis->getSystemIDsFromTreeOnlySource(trillFrame->getEgressRBNickname(), this->isis->getSystemId());
...
bool TRILL::processTRILLDataMultiDest(tFrameDescriptor &frameDesc){
    ...
    std::vector<SystemID> *systemIDs = this->isis->getSystemIDsFromTree(trillFrame->getEgressRBNickname(), this->isis->getSystemId());

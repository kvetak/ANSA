...
//}
//
//TRILLNickname TRILLFrame::getEgressRBNickname() const
//{
//    return egressRBNickname_var;
//}
//
//void TRILLFrame::setEgressRBNickname(TRILLNickname egressRBNickname)
//{
//    this->egressRBNickname_var = egressRBNickname;
//}
//
//TRILLNickname TRILLFrame::getIngressRBNickname() const
//{
//    return ingressRBNickname_var;
//}
//
//void TRILLFrame::setIngressRBNickname(TRILLNickname ingressRBNickname)
//{
...
//{
//    if (k>=options_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", options_arraysize, k);

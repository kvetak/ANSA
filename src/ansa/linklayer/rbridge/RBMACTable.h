...
public:
  ...
  typedef std::pair<inet::MACAddress, int> ESTKey;
  ...
  void updateNative(inet::MACAddress& addr, int vlanId, int gateId);
  void updateTRILLData(inet::MACAddress& addr, int vlanId, int ingressNickname);

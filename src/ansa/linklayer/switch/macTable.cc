...
void MACTable::update(inet::MACAddress& addr, int port) {
	Enter_Method_Silent();
...
MACTable::tSpec MACTable::getSpec(inet::MACAddress& addr) {
	Enter_Method_Silent();
...
MACTable::tPortList& MACTable::getPorts(inet::MACAddress& addr) {
...
void MACTable::add(inet::MACAddress addr, int port, tType type, tSpec spec) {
  AddressTable::iterator iter;
...
void MACTable::remove(inet::MACAddress addr) {
	AddressTable::iterator iter;
...
void MACTable::removePort(inet::MACAddress addr, int port) {
	AddressTable::iterator iter;
...
void MACTable::addStatic(inet::MACAddress addr, tPortList ports) {
	AddressTable::iterator iter;

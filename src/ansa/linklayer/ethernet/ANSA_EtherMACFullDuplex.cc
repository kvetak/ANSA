...
#include "ansa/linklayer/ethernet/ANSA_EtherMACFullDuplex.h"
...
namespace inet{
Define_Module(ANSA_EtherMACFullDuplex);

void ANSA_EtherMACFullDuplex::initialize(int stage)
{
    ANSA_EtherMACBaseVF::initialize(stage);
...
void ANSA_EtherMACFullDuplex::handleMessage(cMessage *msg)
{
    if (!isOperational) {
...
void ANSA_EtherMACFullDuplex::startFrameTransmission()
{
    ASSERT(curTxFrame);
...
void ANSA_EtherMACFullDuplex::processFrameFromUpperLayer(EtherFrame *frame)
{
...
void ANSA_EtherMACFullDuplex::processMsgFromNetwork(cPacket *pk)
{
...
void ANSA_EtherMACFullDuplex::handleEndIFGPeriod()
{
...
void ANSA_EtherMACFullDuplex::handleEndTxPeriod()
{
...
void ANSA_EtherMACFullDuplex::handleEndPausePeriod()
{
    ASSERT(nullptr == curTxFrame);
...
void ANSA_EtherMACFullDuplex::processReceivedDataFrame(EtherFrame *frame)
{
    // statistics
...
void ANSA_EtherMACFullDuplex::processPauseCommand(int pauseUnits)
{
    if (transmitState == TX_IDLE_STATE) {
...
void ANSA_EtherMACFullDuplex::scheduleEndIFGPeriod()
{
    ASSERT(nullptr == curTxFrame);
...
void ANSA_EtherMACFullDuplex::scheduleEndPausePeriod(int pauseUnits)
{
    ASSERT(nullptr == curTxFrame);
...
void ANSA_EtherMACFullDuplex::beginSendFrames()
{
    if (curTxFrame) {

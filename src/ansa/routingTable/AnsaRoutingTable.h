...
#ifndef __ANSAROUTINGTABLE_H
#define __ANSAROUTINGTABLE_H
 ...
 */
class INET_API AnsaRoutingTable: public cSimpleModule, public IRoutingTable, protected INotifiable
{
  protected:

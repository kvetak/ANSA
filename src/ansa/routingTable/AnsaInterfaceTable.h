...
#ifndef __INET_ANSAINTERFACETABLE_H
#define __INET_ANSAINTERFACETABLE_H
 ...
 * @see InterfaceEntry
 */
class INET_API AnsaInterfaceTable : public cSimpleModule, public IInterfaceTable, protected INotifiable
{
  protected:
  ...
  public:
    ...
    InterfaceEntry *getFirstInterface();
};

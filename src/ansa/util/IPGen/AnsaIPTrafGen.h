...
#ifndef __INET_ANSA_IPTRAFGEN_H
#define __INET_ANSA_IPTRAFGEN_H
 ...
 */
class INET_API AnsaIPTrafSink : public cSimpleModule
{
  protected:
    int numReceived;
 ...
 */
class INET_API AnsaIPTrafGen : public AnsaIPTrafSink
{
  protected:
    std::string nodeName;
    int protocol;

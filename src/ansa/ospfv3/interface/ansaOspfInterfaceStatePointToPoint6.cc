...
void AnsaOspf6::InterfaceStatePointToPoint::ProcessEvent(AnsaOspf6::Interface* intf, AnsaOspf6::Interface::InterfaceEventType event){
   ...
   if (event == AnsaOspf6::Interface::HelloTimer){
      if (intf->GetType() == AnsaOspf6::Interface::Virtual) {

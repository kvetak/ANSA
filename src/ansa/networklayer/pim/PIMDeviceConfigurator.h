...
#ifndef __INET_PIMDEVICECONFIGURATOR_H_
#define __INET_PIMDEVICECONFIGURATOR_H_
...
class PIMDeviceConfigurator
{
   ...
   public:
      PIMDeviceConfigurator();
      PIMDeviceConfigurator(const char* devId, const char* devType, const char* confFile, IInterfaceTable* intf);
      virtual ~PIMDeviceConfigurator();

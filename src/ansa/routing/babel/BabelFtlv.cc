 ...
 * @return  Length of raw TLV in bytes
 */
int BabelUpdateFtlv::rawTlvLength(const netPrefix<L3Address>& prevprefix) const
{
    int prefixlen = 0;
 ...
 * @return  Number of copied bytes
 */
int BabelUpdateFtlv::copyRawTlv(char *dst, netPrefix<L3Address> *prevprefix) const
{
    int offset = 0;

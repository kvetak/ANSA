...
bool LISPProbeSet::hasProbeEntry(L3Address& rloc, LISPEidPrefix& eidPref) {
    return findProbeEntryByRlocAndEid(rloc, eidPref);
}

LISPProbeEntry* LISPProbeSet::findProbeEntryByRlocAndEid(L3Address& rloc, const LISPEidPrefix& eidPref) {
...
LISPProbeEntry* LISPProbeSet::findFirstProbeEntryByRloc(const L3Address& rloc) {
    for (ProbeItem it = Probes.begin(); it != Probes.end(); ++it) {
...
void LISPProbeSet::removeProbeEntry(L3Address& rloc, LISPEidPrefix& eidPref) {

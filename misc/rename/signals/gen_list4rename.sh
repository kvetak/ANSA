...
find ../../../src/ansa/linklayer/lldp -name "*.cc" -o -name "*.h" -o -name "*.msg" -o -name "*.ned" | grep -v ../../../src/inet/transportlayer/tcp_lwip/lwip  | grep -v ../../src/inet/routing/extras/ | grep -v /sctp/ | grep -v '_m.' | sort >filelist4rename.txt
